...
CREATE INDEX IF NOT EXISTS idx_created_at ON blocks_monitor_data (created_at);
CREATE INDEX IF NOT EXISTS idx_updated_at ON blocks_monitor_data (updated_at);
